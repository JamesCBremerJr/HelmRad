!
!  Potential is a Gaussian bump, incoming wave is circular
!

module expr_bump_functions
...
call image_incident(ipart,"bump_incident.pdf",2*R,dlambda,wavefun,userptr)
call helmrad_init(ifout,eps,m,xsings,R,dlambda,potfun,userptr,helmdata)
call helmrad_solve(helmdata,wavefun,userptr,scatdata)
...
call pyplot_end(istatus,"bump_q.pdf")
call system("python bump_q.py")
...
iw = 20
open(iw,FILE='bump.dat',STATUS='old')
...
call pyplot_end(istatus,"bump_graph1.pdf")
call system("python bump_graph1.py")





open(iw,FILE='bump_graph2.py')
...
call pyplot_end(istatus,"bump_graph2.pdf")
call system("python bump_graph2.py")
