...
iw = 25
open(iw,FILE='pbessel_table1.tex')
...
iw = 101
open(iw,FILE='pbessel_graph9.py')
...
call pyplot_end(istatus,"pbessel_graph9.pdf")
call system("python pbessel_graph9.py")
...
iw = 101
open(iw,FILE='pbessel_graph10.py')
call pyplot_begin(iw,istatus)
...
call pyplot_end(istatus,"pbessel_graph10.pdf")
call system("python pbessel_graph10.py")
